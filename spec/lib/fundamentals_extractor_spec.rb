  ...
  describe '#earnings_and_dividends' do
    it 'extracts the earings and dividends per year' do
      expect(subject.earnings_and_dividends).to eq(
        {
          '2016' => { dividend: 0.16, eps: 1.11},
          '2017' => { dividend: 0.23, eps: 1.56},
          '2018' => { dividend: 0.25, eps: 1.54},
          '2019' => { dividend: 0.14, eps: 1.12},
          '2020' => { dividend: 0.22, eps: 0.50},
          '2021' => { dividend: 0.23, eps: 0.55},
          '2022' => { dividend: nil, eps: -0.58},
        }
      )
    end
  end
